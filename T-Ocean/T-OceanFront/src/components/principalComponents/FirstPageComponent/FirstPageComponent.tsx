    ...
    return(
        <>
            ...
            <div className="containerFirstPage">
                <div className="informacionContainer-FirstPage">
                ...
                <div className="newsContainer-FirstPage">

                    Aqui va ir la seccion de noticias
                </div>

                <div className="videosContainer-FirstPage">
                    <div className="videosContainer-Flex">
                        <VideosComponent />
                    </div>
                ...
                <div className="eventContainer-FirstPage">    
